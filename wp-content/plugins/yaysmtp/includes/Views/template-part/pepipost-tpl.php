...
if ( ! empty( $params ) ) {
	if ( ! empty( $settings[ $mailer ] ) && isset( $settings[ $mailer ]['api_key'] ) ) {
		$pepipostApiKey = $settings[ $mailer ]['api_key'];
	}
}
?>
  ...
  <div class="yay-smtp-card-header">
	<div class="yay-smtp-card-title-wrapper">
	  <h3 class="yay-smtp-card-title yay-smtp-card-header-item">
		Step 3: Config for Pepipost
		<div class="yay-tooltip doc-setting">
		  <a class="yay-smtp-button" href="https://yaycommerce.gitbook.io/yaysmtp/how-to-set-up-smtps/how-to-connect-pepipost/" target="_blank">
		  ...
		  <span class="yay-tooltiptext yay-tooltip-bottom">Pepipost Documentation</span>
		</div>
	  </h3>
  ...
  <div class="yay-smtp-card-body">
	<div class="setting-el">
	  ...
	  <div class="setting-field">
		<input data-setting="api_key" type="password" spellcheck="false" class="yay-settings" value="<?php echo esc_attr( $pepipostApiKey ); ?>">
		<p class="setting-description">
		  Click here to
		  <a href="https://app.pepipost.com/app/settings/integration" target="_blank" rel="noopener noreferrer">Create API Key</a>
		</p>
	  </div>
	</div>
  </div>
