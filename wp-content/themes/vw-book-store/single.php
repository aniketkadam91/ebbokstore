    ...
    <?php
      ...
      <div class="row">
        ...
        <div id="our-services" class="services col-lg-8 col-md-8">
          <?php if(get_theme_mod('vw_book_store_single_post_breadcrumb',true) == 1){ ?>
            <div class="bradcrumbs">
              <?php vw_book_store_the_breadcrumb(); ?>
            </div>
          <?php }?> 
          <?php if ( have_posts() ) :
            /* Start the Loop */
          ...
          <div class="navigation">
            <?php
              ...
              the_posts_pagination( array(
                'prev_text' => __( 'Previous page', 'vw-book-store' ),
                'next_text' => __( 'Next page', 'vw-book-store' ),
                'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'vw-book-store' ) . ' </span>',
              ) );
            ?>
