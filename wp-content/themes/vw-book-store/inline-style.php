<?php
	...
	if($vw_book_store_second_color != false){
		$vw_book_store_custom_css .='.search-box i, .top-bar .custom-social-icons i:hover, .post-main-box h3 a, .entry-content a, .main-navigation .current_page_item > a, .main-navigation .current-menu-item > a, .main-navigation a:hover, .post-main-box h2 a, h2.section-title a, #footer .textwidget a, .logo .site-title a:hover, .top-bar a:hover, .entry-summary a{';
	...
	$vw_book_store_theme_lay = get_theme_mod( 'vw_book_store_slider_opacity_color','0.7');
	...
	$vw_book_store_slider_image_overlay = get_theme_mod('vw_book_store_slider_image_overlay', true);
	if($vw_book_store_slider_image_overlay == false){
		$vw_book_store_custom_css .='#slider img{';
			$vw_book_store_custom_css .='opacity:1;';
		$vw_book_store_custom_css .='}';
	}

	$vw_book_store_slider_image_overlay_color = get_theme_mod('vw_book_store_slider_image_overlay_color', true);
	if($vw_book_store_slider_image_overlay_color != false){
		$vw_book_store_custom_css .='#slider{';
			$vw_book_store_custom_css .='background-color: '.esc_attr($vw_book_store_slider_image_overlay_color).';';
		$vw_book_store_custom_css .='}';
	}
	...
	$vw_book_store_blog_page_posts_settings = get_theme_mod( 'vw_book_store_blog_page_posts_settings','Into Blocks');
    if($vw_book_store_blog_page_posts_settings == 'Without Blocks'){
		$vw_book_store_custom_css .='.post-main-box{';
			$vw_book_store_custom_css .='box-shadow: none; border: none; margin:30px 0;';
		$vw_book_store_custom_css .='}';
	}

	// featured image dimention
	$vw_book_store_blog_post_featured_image_dimension = get_theme_mod('vw_book_store_blog_post_featured_image_dimension', 'default');
	$vw_book_store_blog_post_featured_image_custom_width = get_theme_mod('vw_book_store_blog_post_featured_image_custom_width',250);
	$vw_book_store_blog_post_featured_image_custom_height = get_theme_mod('vw_book_store_blog_post_featured_image_custom_height',250);
	if($vw_book_store_blog_post_featured_image_dimension == 'custom'){
		$vw_book_store_custom_css .='.box-image img{';
			$vw_book_store_custom_css .='width: '.esc_attr($vw_book_store_blog_post_featured_image_custom_width).'; height: '.esc_attr($vw_book_store_blog_post_featured_image_custom_height).';';
		$vw_book_store_custom_css .='}';
	}
	...
	$vw_book_store_resp_slider = get_theme_mod( 'vw_book_store_resp_slider_hide_show',true);
	...
	$vw_book_store_menus_item = get_theme_mod( 'vw_book_store_menus_item_style','None');
    if($vw_book_store_menus_item == 'None'){
		$vw_book_store_custom_css .='.main-navigation a{';
			$vw_book_store_custom_css .='';
		$vw_book_store_custom_css .='}';
	}else if($vw_book_store_menus_item == 'Zoom In'){
		$vw_book_store_custom_css .='.main-navigation a:hover{';
			$vw_book_store_custom_css .='transition: all 0.3s ease-in-out !important; transform: scale(1.2) !important; color: #46bf72;';
		$vw_book_store_custom_css .='}';
	}

	$vw_book_store_navigation_menu_font_weight = get_theme_mod('vw_book_store_navigation_menu_font_weight','700');
	if($vw_book_store_navigation_menu_font_weight != false){
		$vw_book_store_custom_css .='.main-navigation a{';
			$vw_book_store_custom_css .='font-weight: '.esc_attr($vw_book_store_navigation_menu_font_weight).';';
		$vw_book_store_custom_css .='}';
	}

	$vw_book_store_theme_lay = get_theme_mod( 'vw_book_store_menu_text_transform','Uppercase');
	if($vw_book_store_theme_lay == 'Capitalize'){
		$vw_book_store_custom_css .='.main-navigation a{';
			$vw_book_store_custom_css .='text-transform:Capitalize;';
		$vw_book_store_custom_css .='}';
	}
	if($vw_book_store_theme_lay == 'Lowercase'){
		$vw_book_store_custom_css .='.main-navigation a{';
			$vw_book_store_custom_css .='text-transform:Lowercase;';
		$vw_book_store_custom_css .='}';
	}
	if($vw_book_store_theme_lay == 'Uppercase'){
		$vw_book_store_custom_css .='.main-navigation a{';
			$vw_book_store_custom_css .='text-transform:Uppercase;';
		$vw_book_store_custom_css .='}';
	}
    ...
    if($vw_book_store_menus_item == 'None'){
		...
		$vw_book_store_custom_css .='.main-navigation a:hover{';
			$vw_book_store_custom_css .='transition: all 0.3s ease-in-out !important; transform: scale(1.2) !important; color: #7fbe4b;';
		$vw_book_store_custom_css .='}';
	}
	...
	$vw_book_store_button_font_size = get_theme_mod('vw_book_store_button_font_size',14);
	$vw_book_store_custom_css .='.post-main-box .blogbutton-small{';
		$vw_book_store_custom_css .='font-size: '.esc_attr($vw_book_store_button_font_size).';';
	$vw_book_store_custom_css .='}';

	$vw_book_store_theme_lay = get_theme_mod( 'vw_book_store_button_text_transform','Uppercase');
	if($vw_book_store_theme_lay == 'Capitalize'){
		$vw_book_store_custom_css .='.post-main-box .blogbutton-small{';
			$vw_book_store_custom_css .='text-transform:Capitalize;';
		$vw_book_store_custom_css .='}';
	...
	$vw_book_store_button_letter_spacing = get_theme_mod('vw_book_store_button_letter_spacing',14);
	$vw_book_store_custom_css .='.post-main-box .blogbutton-small{';
		$vw_book_store_custom_css .='letter-spacing: '.esc_attr($vw_book_store_button_letter_spacing).';';
	$vw_book_store_custom_css .='}';
	...
	$vw_book_store_footer_padding = get_theme_mod('vw_book_store_footer_padding');
	if($vw_book_store_footer_padding != false){
		$vw_book_store_custom_css .='#footer{';
			$vw_book_store_custom_css .='padding: '.esc_attr($vw_book_store_footer_padding).' 0;';
		$vw_book_store_custom_css .='}';
	}
	...
	$vw_book_store_copyright_background_color = get_theme_mod('vw_book_store_copyright_background_color');
	if($vw_book_store_copyright_background_color != false){
		$vw_book_store_custom_css .='#footer-2{';
			$vw_book_store_custom_css .='background-color: '.esc_attr($vw_book_store_copyright_background_color).';';
		$vw_book_store_custom_css .='}';
	}
	...
	if($vw_book_store_copyright_font_size != false){
		$vw_book_store_custom_css .='.copyright p, .copyright a{';
			$vw_book_store_custom_css .='font-size: '.esc_attr($vw_book_store_copyright_font_size).';';
		$vw_book_store_custom_css .='}';
	}

	$vw_book_store_copyright_font_weight = get_theme_mod('vw_book_store_copyright_font_weight');
	if($vw_book_store_copyright_font_weight != false){
		$vw_book_store_custom_css .='.copyright p, .copyright a{';
			$vw_book_store_custom_css .='font-weight: '.esc_attr($vw_book_store_copyright_font_weight).';';
		$vw_book_store_custom_css .='}';
	}

	$vw_book_store_copyright_text_color = get_theme_mod('vw_book_store_copyright_text_color');
	if($vw_book_store_copyright_text_color != false){
		$vw_book_store_custom_css .='.copyright p, .copyright a{';
			$vw_book_store_custom_css .='color: '.esc_attr($vw_book_store_copyright_text_color).';';
		$vw_book_store_custom_css .='}';
	} 
	...
	$vw_book_store_footer_background_image = get_theme_mod('vw_book_store_footer_background_image');
	if($vw_book_store_footer_background_image != false){
		$vw_book_store_custom_css .='#footer{';
			$vw_book_store_custom_css .='background: url('.esc_attr($vw_book_store_footer_background_image).');';
		$vw_book_store_custom_css .='}';
	}

	$vw_book_store_footer_icon = get_theme_mod('vw_book_store_footer_icon');
	if($vw_book_store_footer_icon == false){
		$vw_book_store_custom_css .='.copyright p{';
			$vw_book_store_custom_css .='width:100%; text-align:center; float:none;';
		$vw_book_store_custom_css .='}';
	}

	$vw_book_store_theme_lay = get_theme_mod( 'vw_book_store_img_footer','scroll');
	if($vw_book_store_theme_lay == 'fixed'){
		$vw_book_store_custom_css .='#footer{';
			$vw_book_store_custom_css .='background-attachment: fixed !important; background-position: center !important;';
		$vw_book_store_custom_css .='}';
	}elseif ($vw_book_store_theme_lay == 'scroll'){
		$vw_book_store_custom_css .='#footer{';
			$vw_book_store_custom_css .='background-attachment: scroll !important; background-position: center !important;';
		$vw_book_store_custom_css .='}';
	}

	$vw_book_store_footer_img_position = get_theme_mod('vw_book_store_footer_img_position','center center');
	if($vw_book_store_footer_img_position != false){
		$vw_book_store_custom_css .='#footer{';
			$vw_book_store_custom_css .='background-position: '.esc_attr($vw_book_store_footer_img_position).'!important;';
		$vw_book_store_custom_css .='}';
	}
	...
	$vw_book_store_related_product_show_hide = get_theme_mod('vw_book_store_related_product_show_hide',true);
	if($vw_book_store_related_product_show_hide != true){
		$vw_book_store_custom_css .='.related.products{';
			$vw_book_store_custom_css .='display: none;';
		$vw_book_store_custom_css .='}';
	}
	...
	$vw_book_store_site_title_color = get_theme_mod('vw_book_store_site_title_color');
	if($vw_book_store_site_title_color != false){
		$vw_book_store_custom_css .='p.site-title a{';
			$vw_book_store_custom_css .='color: '.esc_attr($vw_book_store_site_title_color).'!important;';
		$vw_book_store_custom_css .='}';
	}

	$vw_book_store_site_tagline_color = get_theme_mod('vw_book_store_site_tagline_color');
	if($vw_book_store_site_tagline_color != false){
		$vw_book_store_custom_css .='.logo p.site-description{';
			$vw_book_store_custom_css .='color: '.esc_attr($vw_book_store_site_tagline_color).';';
		$vw_book_store_custom_css .='}';
	}

	$vw_book_store_logo_width = get_theme_mod('vw_book_store_logo_width');
	if($vw_book_store_logo_width != false){
		$vw_book_store_custom_css .='.logo img{';
			$vw_book_store_custom_css .='width: '.esc_attr($vw_book_store_logo_width).';';
		$vw_book_store_custom_css .='}';
	}

	$vw_book_store_logo_height = get_theme_mod('vw_book_store_logo_height');
	if($vw_book_store_logo_height != false){
		$vw_book_store_custom_css .='.logo img{';
			$vw_book_store_custom_css .='height: '.esc_attr($vw_book_store_logo_height).';';
		$vw_book_store_custom_css .='}';
	}

	// Woocommerce img

	$vw_book_store_shop_featured_image_border_radius = get_theme_mod('vw_book_store_shop_featured_image_border_radius', 0);
	if($vw_book_store_shop_featured_image_border_radius != false){
		$vw_book_store_custom_css .='.woocommerce ul.products li.product a img{';
			$vw_book_store_custom_css .='border-radius: '.esc_attr($vw_book_store_shop_featured_image_border_radius).'px;';
		$vw_book_store_custom_css .='}';
	}

	$vw_book_store_shop_featured_image_box_shadow = get_theme_mod('vw_book_store_shop_featured_image_box_shadow');
	if($vw_book_store_shop_featured_image_box_shadow != false){
		$vw_book_store_custom_css .='.woocommerce ul.products li.product a img{';
				$vw_book_store_custom_css .='box-shadow: '.esc_attr($vw_book_store_shop_featured_image_box_shadow).'px '.esc_attr($vw_book_store_shop_featured_image_box_shadow).'px '.esc_attr($vw_book_store_shop_featured_image_box_shadow).'px #ddd;';
		$vw_book_store_custom_css .='}';
	}
	...
	$vw_book_store_preloader_bg_img = get_theme_mod('vw_book_store_preloader_bg_img');
	if($vw_book_store_preloader_bg_img != false){
		$vw_book_store_custom_css .='#preloader{';
			$vw_book_store_custom_css .='background: url('.esc_attr($vw_book_store_preloader_bg_img).');-webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;';
		$vw_book_store_custom_css .='}';
	}

	// Header Background Color

	$vw_book_store_header_background_color = get_theme_mod('vw_book_store_header_background_color');
	if($vw_book_store_header_background_color != false){
		$vw_book_store_custom_css .='#header{';
			$vw_book_store_custom_css .='background-color: '.esc_attr($vw_book_store_header_background_color).';';
		$vw_book_store_custom_css .='}';
	}

	$vw_book_store_header_img_position = get_theme_mod('vw_book_store_header_img_position','center top');
	if($vw_book_store_header_img_position != false){
		$vw_book_store_custom_css .='.home-page-header, #header{';
			$vw_book_store_custom_css .='background-position: '.esc_attr($vw_book_store_header_img_position).'!important;';
		$vw_book_store_custom_css .='}';
	} 

	/*--------------------- Grid Posts Posts -------------------*/

	$vw_book_store_display_grid_posts_settings = get_theme_mod( 'vw_book_store_display_grid_posts_settings','Into Blocks');
    if($vw_book_store_display_grid_posts_settings == 'Without Blocks'){
		$vw_book_store_custom_css .='.grid-post-main-box{';
			$vw_book_store_custom_css .='box-shadow: none; border: none; margin:30px 0;';
		$vw_book_store_custom_css .='}';
	}