        ...
        <div class="entry-attachment">
            ...
            <?php if ( has_excerpt() ) : ?>
                <div class="entry-caption">
                    <div class="entry-content"><p><?php $vw_book_store_excerpt = get_the_excerpt(); echo esc_html( vw_book_store_string_limit_words( $vw_book_store_excerpt, esc_attr(get_theme_mod('vw_book_store_excerpt_number','30')))); ?></p></div>
                </div>
            <?php endif; ?>
        </div>    
        <?php
