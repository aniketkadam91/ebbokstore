...
<div id="header" class="menubar <?php if( get_theme_mod( 'vw_book_store_sticky_header', false) == 1 || get_theme_mod( 'vw_book_store_stickyheader_hide_show', false) == 1) { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
  <div class="container">
        ...
        <?php $blog_info = get_bloginfo( 'name' ); ?>
          <?php if ( ! empty( $blog_info ) ) : ?>
            <?php if ( is_front_page() && is_home() ) : ?>
              <?php if( get_theme_mod('vw_book_store_logo_title_hide_show',true) == 1){ ?>
          ...
          ?>
          <?php if( get_theme_mod('vw_book_store_tagline_hide_show',false) == 1){ ?>
