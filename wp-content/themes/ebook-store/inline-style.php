<?php
	...
	if($vw_book_store_first_color != false){
		$vw_book_store_custom_css .='.cart_icon i, .wishlist i, .entry-content .wp-block-button__link{';
			$vw_book_store_custom_css .='border-color: '.esc_attr($vw_book_store_first_color).'!important;';
		$vw_book_store_custom_css .='}';
	}
	if($vw_book_store_first_color != false){
	...
	if($vw_book_store_header_background_color != false){
		$vw_book_store_custom_css .='.search-bar{';
