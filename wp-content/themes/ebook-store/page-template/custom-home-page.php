...
<main id="maincontent" role="main">
  ...
  <?php if( get_theme_mod( 'vw_book_store_slider_hide_show', false) == 1 || get_theme_mod( 'vw_book_store_resp_slider_hide_show', false) == 1) { ?>
    <section id="slider">
                  ...
                  <div class="inner_carousel">
                    ...
                    <?php if( get_theme_mod('vw_book_store_slider_button_text','READ MORE') != ''){ ?>
                      <div class="more-btn wow zoomInDown" data-wow-duration="3s">
                        <a href="<?php echo esc_url(get_theme_mod('vw_book_store_top_button_url',false));?>">"><?php echo esc_html(get_theme_mod('vw_book_store_slider_button_text',__('READ MORE','ebook-store')));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('vw_book_store_slider_button_text',__('READ MORE','ebook-store')));?></span></a>
                      </div>
                    <?php } ?>
                  </div>
                </div>
