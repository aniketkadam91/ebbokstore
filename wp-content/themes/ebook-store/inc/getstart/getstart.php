		...
		<div id="lite_theme" class="tabcontent open">
			...
			<div class="lite-theme-tab" style="<?php echo esc_attr($ebook_store_plugin_custom_css); ?>">
               ...
               <ul>
                  ...
                  <p><?php esc_html_e(' Once you are done with this, then follow the','ebook-store'); ?> <a class="doc-links" href="https://preview.vwthemesdemo.com/docs/free-ebook-store/" target="_blank"><?php esc_html_e('Documentation','ebook-store'); ?></a></p>
               </ul>
			  	</div>
			</div>
		</div>	
			...
			<div class="gutenberg-editor-tab" style="<?php echo esc_attr($ebook_store_plugin_custom_css); ?>">
				<div class="block-pattern-img">
					...
					<p><?php esc_html_e('Follow the below instructions to setup Home page with Block Patterns.','ebook-store'); ?></p>
	              	<p><b><?php esc_html_e('Click on Below Add new page button >> Click on "+" Icon.','ebook-store'); ?></span></b></p>
				    ...
				    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/inc/getstart/images/block-pattern1.png" alt="" />
				    	<p><b><?php esc_html_e('Click on Patterns Tab >> Click on Theme Name >> Click on Sections >> Publish.','ebook-store'); ?></span></b></p>
