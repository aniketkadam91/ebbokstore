...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20240201_bookstore_52085705fc6180508256_20240201080353_archive.zip';
        const ARCHIVE_SIZE       = '57044897';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '5208570-01080353';
        const SECONDARY_PACKAGE_HASH = 'a4cf4a7-01080353';
        const VERSION            = '1.5.8';
